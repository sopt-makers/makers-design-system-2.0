...
const IconImagePlusOutlined = forwardRef<SVGSVGElement, IconProps>(
  ({ size, ...rest }, ref) => {
    const props = {
...
IconImagePlusOutlined.displayName = "IconImagePlusOutlined";
export default IconImagePlusOutlined;
