...
const IconCameraOffOutlined = forwardRef<SVGSVGElement, IconProps>(
  ({ size, ...rest }, ref) => {
    const props = {
...
IconCameraOffOutlined.displayName = "IconCameraOffOutlined";
export default IconCameraOffOutlined;
